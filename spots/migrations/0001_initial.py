    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vote', models.CharField(choices=[(5.0, '<i class="far fa-laugh-squint EmoticonPicker__Icon EmoticonPicker__Icon--Neutral"></i> 좋았다'), (3.0, '<i class="far fa-meh EmoticonPicker__Icon EmoticonPicker__Icon--Neutral"></i>괜찮다'), (1.0, '<i class="far fa-frown EmoticonPicker__Icon EmoticonPicker__Icon--Neutral"></i>나쁘다')], max_length=7)),
